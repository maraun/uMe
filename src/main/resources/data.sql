...
insert into users (id, created_at, deleted_at, updated_at, email, login, password, profile_id, role_id) values (1, '2019-04-18 19:59:59', null, '2019-04-18 19:59:59', 'admin@u.me', 'admin', '$2a$10$H2PqH5KUkeooBkWeLkKVzOwCcX.6F6Z/HBy4f//rg9/GHiBR8493u', 1, 1);